...
const (
	clienteAPIURL  = "http://ecommerce-usuario-alb-1217182197.us-east-1.elb.amazonaws.com:8080/api/v1/usuario"       // URL da API de cliente
	vendaAPIURL    = "http://ecommerce-produto-alb-1900563212.us-east-1.elb.amazonaws.com:8081/api/v1/produto/venda" // URL da API de venda
